...
import { BookOpen, GraduationCap, ArrowRight, Flame, Trophy, Clock, BookMarked, MessageSquare } from 'lucide-react';
    ...
    <div className="max-w-[1600px] mx-auto space-y-8">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-3xl p-8 md:p-12 text-white shadow-xl shadow-indigo-200 relative overflow-hidden">
          <div className="relative z-10 max-w-2xl">
              <h1 className="text-3xl md:text-5xl font-bold mb-4">{labels.welcomeBack}, {user.name}! 👋</h1>
              <p className="text-indigo-100 text-lg md:text-xl mb-8 opacity-90">{labels.readyToLearn}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  ...
                  <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-col items-center justify-center text-center hover:border-purple-200 transition-colors cursor-pointer group" onClick={() => onNavigate('dashboard')}>
          ...
          <div className="space-y-6">
              <div className="bg-[#fff9e6] p-6 rounded-2xl border border-yellow-200 shadow-sm relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-xs font-bold text-yellow-700 uppercase tracking-widest">{labels.dailyExpression}</span>
                  </div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                  ...
                  <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm font-bold text-indigo-600">{user.savedWords.length} words</span>
                  </div>
                  <div className="w-full bg-slate-100 h-2 rounded-full mb-4">
                      <div className="bg-indigo-500 h-full rounded-full" style={{ width: `${Math.min(user.savedWords.length, 100)}%` }}></div>
                  </div>
                  ...
                  <div className="w-full bg-slate-100 h-2 rounded-full mb-6">
                      <div className="bg-red-500 h-full rounded-full" style={{ width: `${Math.min(user.mistakes.length * 5, 100)}%` }}></div>
                  </div>
