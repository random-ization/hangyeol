...
import { Institute, Language, TextbookContextMap, User, AdminStats, TextbookContent, TopikExam } from '../../types';
...
const AdminPanel: React.FC<AdminPanelProps> = ({
  ...
  const tabs = [
    { id: 'dashboard' as const, label: { en: 'Dashboard', zh: '仪表板', vi: 'Bảng điều khiển', mn: 'Самбар' }, icon: LayoutDashboard },
    { id: 'users' as const, label: { en: 'Users', zh: '用户', vi: 'Người dùng', mn: 'Хэрэглэгчид' }, icon: Users },
    { id: 'curriculum' as const, label: { en: 'Curriculum', zh: '课程', vi: 'Giáo trình', mn: 'Хөтөлбөр' }, icon: BookOpen },
    { id: 'topik' as const, label: { en: 'TOPIK Exams', zh: 'TOPIK考试', vi: 'Kỳ thi TOPIK', mn: 'TOPIK шалгалт' }, icon: FileText },
  ];
